...
namespace PubliPayments.Entidades.Originacion
{
    public class SolicitudInscripcionCreditoModel
    {
        ...
        //Nuevas propiedades
        public string Benef_ApPaterno { get; set; }
        public string Benef_ApMaterno { get; set; }
        public string Benef_Nombre { get; set; }
        public string Clabe { get; set; }
        public string ANombreDh { get; set; }
                    ...
                    foreach (var colum in dataSet.Tables[0].Columns)
                    {
                        ...
                        switch (columnName)
                        {
                            ...
                            case "PensionAlimenticia":
                                modelo.PensionAlimenticia = dataSetString(dataSet, columnName);
                                break;
                            case "Telefono":
                            ...
                            case "Clabe":
                                modelo.Clabe = dataSetString(dataSet, columnName);
                                break;
                            case "NombreBeneficiario":
                                modelo.Benef_Nombre= dataSetString(dataSet, columnName);
                                break;
                            case "ApPaternoBen":
                                modelo.Benef_ApPaterno = dataSetString(dataSet, columnName);
                                break;
                            case "ApMaternoBen":
                                modelo.Benef_ApMaterno = dataSetString(dataSet, columnName);
                                break;
                            case "EmpresaLada":
                                modelo.EmpresaLada= dataSetString(dataSet, columnName);
                                break;
                            case "EmpresaTelefono":
                                modelo.EmpresaTelefono = dataSetString(dataSet, columnName);
                                break;
                            case "EmpresasExt":
                                modelo.EmpresaExtension = dataSetString(dataSet, columnName);
                                break;
                            case "ANombreDh":
                                modelo.ANombreDh = dataSetString(dataSet, columnName);
                                break;
                            case "CorreoElectronico":
                                modelo.CorreoElectronico = dataSetString(dataSet, columnName);
                                break;
                            case "Celular":
                                modelo.Celular = dataSetString(dataSet, columnName);
                                break;
                        }
                    }
                }
