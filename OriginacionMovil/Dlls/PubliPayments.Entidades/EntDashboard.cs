...
{
    public static class EntDashboard
    {
        //private static object _lock = new object();

        public static DataSet Dashboard(string idUsuario, string rol, int parte, string delegacion, string despacho,
            string supervisor, string gestor, string tipoFormulario, string callcenter)
        {
            ...
            parametros[1] = new SqlParameter("@Rol", SqlDbType.VarChar, 25) {Value = rol};
            parametros[2] = new SqlParameter("@callCenter", SqlDbType.VarChar, 6) {Value = callcenter};


            var ds43 = instancia.EjecutarDataSet("SqlDefault", "ObtenerIndicadoresDashboardRol", parametros);
        ...
        private static string ObtenerIndicadorDashboard(SqlConnection cnn, string idUsuario, string indicador,
        ...
        public static DataTable ObtenerFiltros(string idUsuario, string delegacion, string despacho, string supervisor,
            string gestor)
        {
            var instancia = ConnectionDB.Instancia;
