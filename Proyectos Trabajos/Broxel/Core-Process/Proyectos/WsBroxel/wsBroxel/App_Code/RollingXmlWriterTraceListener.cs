    ...
    public class RollingXmlWriterTraceListener : XmlWriterTraceListener
    {
        ...
        private void InitEventLog()
        {
            try
            {
                ...
                if (!EventLog.SourceExists("wsBroxelServiceSource"))
                {
                    EventLog.CreateEventSource(
                        "wsBroxelServiceSource", "wsBroxelServiceLog");
                }
                _eventLog.Source = "wsBroxelServiceSource";
                _eventLog.Log = "wsBroxelServiceLog";
            }
            catch
            {
