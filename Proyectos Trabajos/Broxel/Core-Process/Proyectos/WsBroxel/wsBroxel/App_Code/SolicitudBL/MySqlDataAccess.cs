    ...
    public class MySqlDataAccess
    {
        ...
        public List<CargosDisposiciones> ObtenerCargosDisposiciones(string numCuenta, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            try
            {
                ...
                var query = @"select numcuenta, idDisposicion, numautorizacion, monto from CargosDisposicionesEfectivo where NumCuenta = '" + numCuenta + "' and date(fechaHoraCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "';";
...
//                              where cuentadestino = '" + numCuenta + "' and date(fechaHoraCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "';";
                ...
                var query = @"select a.fechaHoraCreacion as FechaCreacion,b.codigoAutorizacion as CodigoAutorizacion, m1.nombre_titular Remitente, m2.nombre_titular Destinatario, b.MontoComision Comision, a.ConceptoTransferencia
                             ...
                             where cuentadestino = '" + numCuenta  + "' and date(fechaHoraCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "' and m1.num_cuenta = b.CuentaOrigen and m2.num_cuenta = b.CuentaDestino;";
...
//                              where cuentaorigen = '" + numCuenta + "' and date(fechaHoraCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "';";
                ...
                var query = @"select a.fechaHoraCreacion as FechaCreacion,b.codigoAutorizacion as CodigoAutorizacion, m1.nombre_titular Remitente, m2.nombre_titular Destinatario,b.MontoComision Comision, a.ConceptoTransferencia
                              from TransferenciasSolicitud a join TransferenciasDetalle b on a.folio = b.folioSolicitud, maquila m1, maquila m2
                              where cuentaorigen = '" + numCuenta + "' and date(fechaHoraCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "' and m1.num_cuenta = b.CuentaOrigen and m2.num_cuenta = b.CuentaDestino;";
        ...
        public List<TransferenciasDisposicion> ObtenerTransferenciasDisposicion(string numCuenta, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            try
            {
                ...
                var query = @" select a.NumAutorizacion, b.fechaHoraCreacion, d.Nombre as Destinatario from CargosDisposicionesEfectivo a
                               ...
                               where a.numCuenta = '" + numCuenta + "' and date(a.fechaHoraCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "' and a.IdMovimiento > 0 and a.Autorizado = 1;";
        ...
        public List<TransferenciasAbonosACuenta> ObtenerTrasnferenciasAbonos(string numCuenta, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            try
            {
                ...
                var query = @"SELECT b.codigoAutorizacionPOS as codigoAutorizacion , a.fechaCreacion, d.Nombre as Remitente
                              ...
                              where a.cuenta = '" + numCuenta + "' and date(a.fechaCreacion) between '" + fechaInicio.ToString("yyyy-MM-dd") + "' and '" + fechaFin.ToString("yyyy-MM-dd") + "';";
        ...
        public List<DetalleComisionAsignacion> ObtenerComisionTarjeta(string producto, string claveClienteCorporativo)
        {
            ...
            try
            {
                ...
                var sql = @"select  
                            ...
                            where dt.Estatus = 1 and ct.Estatus = 1 and dt.Producto ='" + producto + "' and dt.ClaveCliente ='" + claveClienteCorporativo + "'";
        ...
        public bool SpInsDispersionesFromWs(long folio)
        {
            ...
            try
            {
                ...
                {
                    Connection = _conn,
                    CommandText = "call spInsDispersionesFromWS(" + folio.ToString(CultureInfo.InvariantCulture) + ");",
                    CommandType = CommandType.Text,
                    CommandTimeout = 1200
                };
                cmd.ExecuteNonQuery();
        ...
        public bool SpInsPagosFromWs(long folio)
        {
            ...
            try
            {
                ...
                {
                    Connection = _conn,
                    CommandText = "call spInsPagosFromWS(" + folio.ToString(CultureInfo.InvariantCulture) + ");",
                    CommandType = CommandType.Text,
                    CommandTimeout = 1200
                };
                cmd.ExecuteNonQuery();
        ...
        public bool spInsDevolucionesFromWS(long folio)
        {
            ...
            try
            {
                ...
                {
                    Connection = _conn,
                    CommandText = "call spInsDevolucionesFromWS(" + folio.ToString(CultureInfo.InvariantCulture) + ");",
                    CommandType = CommandType.Text,
                    CommandTimeout = 1200
                };
                cmd.ExecuteNonQuery();
        ...
        public WsInvokeData GetWsInvokeData(long folio)
        {
            ...
            try
            {
                ...
                var sql = "select a.idSolicitud, b.email " +
                          ...
                          "where folio = " + folio.ToString(CultureInfo.InvariantCulture);
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select folio, status " +
                                  ...
                                  "where idTransacFrom = " + idTransac +
                                  " and cuenta = '" + numCuenta +
                                  "' and idUser = '" + idUser +
                                  "' and status <> 100;",
                    Connection = _conn,
                    CommandType = CommandType.Text
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select l.id, d.CLABE  " +
                                  ...
                                  "where l.Monto = " + monto.ToString("F2") + " and l.Motivo = 'RecepcionTransferenciawsSPEI' " +
        ...
        public string InsertDetalleDispersionesWs(long folio, string cuenta, decimal saldo = 0)
        {
            ...
            try
            {
                _conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["MySQLBroxel_RDG"].ToString());
                _conn.Open();
                var sql = "insert into dispersiones_ws_detalles (folio, cuenta, saldo) values (" + folio.ToString(CultureInfo.InvariantCulture) + ",'" + cuenta + "', " + saldo.ToString(CultureInfo.InvariantCulture) + ");";
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
            ...
            try
            {
                ...
                var cmd2 = new MySqlCommand
                {
                    CommandText = "insert into dispersionesInternas (idSolicitud, cuenta, incrementoPOS, incrementoATM, producto, claveCliente) " +
                                  "values ('" + folio + "', '" + cuenta + "', " + montoPos.ToString(CultureInfo.InvariantCulture) +
                                  ", " + (montoPos * perc).ToString(CultureInfo.InvariantCulture) + ", '" + producto + "', '" + claveCliente + "')",
                    CommandType = CommandType.Text,
                    CommandTimeout = 1200,
                    Connection = _conn
                };
        ...
        public bool SpPostRenominacion(long idSolicitud, ref string msg)
        {
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "call SpPostRenominacion(" + idSolicitud.ToString(CultureInfo.InvariantCulture) + ");",
                    Connection = _conn,
                    CommandType = CommandType.Text,
                    CommandTimeout = 1200
                };
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select ac.cuenta " +
                                  ...
                                  "where c.idComercio = " + idComercio.ToString(CultureInfo.InvariantCulture),
                    CommandType = CommandType.Text,
                    Connection = _conn,
                    CommandTimeout = 1200
                };
        ...
        public void RespaldaAccesosClientes(int idUsuarioOnlineBroxel)
        {
            try
            {
                ...
                var sql = "insert into accessos_clientesbk " +
                          "select * from accessos_clientes where idUsuarioOnlineBroxel = " + idUsuarioOnlineBroxel.ToString(CultureInfo.InvariantCulture) + "; " +
                          "delete from accessos_clientes where idUsuarioOnlineBroxel = " + idUsuarioOnlineBroxel.ToString(CultureInfo.InvariantCulture) + ";";
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
        ...
        public long InsertaEnCuarentena(CuarentenaNivelesData cuarentena)
        {
            ...
            try
            {
                ...
                var sql = "insert into CuarentenaCuentas (numCuenta, nivelIngreso, fechaIngreso, usuarioIngreso) " +
                          "values ('"+ cuarentena.NumCuenta + "', " + cuarentena.NivelIngreso.ToString(CultureInfo.InvariantCulture) + ", now(), '"+ cuarentena.UsuarioIngreso + "');";
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
        ...
        public int SacaDeCuarentena(string numCuenta, string usuario)
        {
            ...
            try
            {
                ...
                var sql = "update CuarentenaCuentas " +
                          "set fechaSalida = now(), usuarioSalida = '" + (string.IsNullOrEmpty(usuario)?"NO IDENTIFICADO":usuario) + "' " +
        ...
        public long InsertLogMensajeAvisoNivel(string celular, string numCuenta, string msg, decimal monto, int idAviso )
        {
            ...
            try
            {
                ...
                var sql = "insert into LogMensagesAvisosNivelDeCuenta (Date, Celular, NumCuenta, Mensaje, Monto,IdCatNivelAviso ) " +
                          "values (now(), '" + celular + "', '" + numCuenta + "', '" + msg + "', '" + monto.ToString() + "', " + idAviso + ");";
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select a.id, a.cuentaFavorita cuenta, b.`nro-tarjeta` Tarjeta, a.Alias, b.producto, c.descripcion " +
                                  ...
                                  "where a.idUser = " + idUsuario.ToString(CultureInfo.InvariantCulture) + " and status = 1",
                    Connection = _conn,
                    CommandType = CommandType.Text
                };
                var dr = cmd.ExecuteReader();
        ...
        public string GetClaveCliente(int idMaquila)
        {
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select clave_Cliente from maquila where id = " + idMaquila.ToString(CultureInfo.InvariantCulture) + ";",
                    Connection = _conn,
                    CommandType = CommandType.Text
                };
                var dr = cmd.ExecuteReader();
        ...
        public long InsertCambiaContrasenaLog(int idUser, string original, string nueva)
        {
            ...
            try
            {
                ...
                var sql = "insert into CambiaContrasenaLog (idUser, original, new) " +
                          "values (" + idUser.ToString(CultureInfo.InvariantCulture) + ",'" + original + "', '" + nueva +
                          "');";
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
        ...
        public List<MovimientoOnline> GetPagosTransferencias(string numCuenta, DateTime fechaIni, DateTime fechaFin, int tipo)
        {
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "call spObtenPagosTransferencias('" + numCuenta + "', '" + fechaIni.ToString("yyyy-MM-dd") + "', '" + fechaFin.ToString("yyyy-MM-dd") + "', " + tipo.ToString(CultureInfo.InvariantCulture) + ");",
                    Connection = _conn,
                    CommandType = CommandType.Text
                };
                var dr = cmd.ExecuteReader();
        ...
        public long InsertVcConsulta(int idApp, string usuario, string token)
        {
            ...
            try
            {
                _conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["MySQLBroxel_RDG"].ToString());
                _conn.Open();
                var sql = "insert into LogConsultasVC (idApp, usuario, token) values ( " + idApp.ToString(CultureInfo.InvariantCulture) + ", '" + usuario + "','" + token + "');";
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select m.id, m.num_cuenta " +
                                  ...
                                  "where cbl.idApp = " + idApp.ToString(CultureInfo.InvariantCulture) +
                                  " and cbl.producto = '" + producto + "' and length(num_cuenta)=9 and ac.id is null order by maquila desc; ",
                    Connection = _conn,
                    CommandType = CommandType.Text
                };
                var dr = cmd.ExecuteReader();
        ...
        public MaquilaVcInfo GetIdMaquilaAonFromPull(int idApp, string producto)
        {
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                   ...
                   "left join accessos_clientes ac on m.id = ac.idMaquila where cbl.idApp = " + idApp.ToString(CultureInfo.InvariantCulture) +
                   " and cbl.producto ='" + producto + "' and length(num_cuenta)=9 and ac.id is null ) as c" +
        ...
        public bool CreaClienteBroxel(int idClienteLog, string producto, int idMaquila, bool esFisica)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "call spCreaClienteBroxel(" + idClienteLog.ToString(CultureInfo.InvariantCulture) + ", '" + producto + "', " + idMaquila.ToString(CultureInfo.InvariantCulture) + ", " + (esFisica ? "1" : "0") + ");";
        ...
        public bool CreaClienteComercioBroxel(int idComercio,int idLayout, string producto, int idMaquila)
        {
            ...
            try
            {
                ...
                {
                    Connection = _conn,
                    CommandText = "call spCreaClienteComercio(" + idComercio.ToString(CultureInfo.InvariantCulture) +
                                  "," + idLayout.ToString(CultureInfo.InvariantCulture) + ",'" + producto + "'," +
                                  idMaquila.ToString(CultureInfo.InvariantCulture) + ");",
                    CommandType = CommandType.Text,
                    CommandTimeout = 1200
                };
        ...
        public bool ConectaMaquila(int idCreaLog, int idMaquila, string producto)
        {
            ...
            try
            {
                ...
                var sql = "update maquila m join " +
                          "(select '" + producto + "' as producto, claveCliente, " + idMaquila.ToString(CultureInfo.InvariantCulture) + " as idMaquila from CreaClienteSinTarjetaLog where id = " + idCreaLog + ") b " +
        ...
        public VcTokenData GetUsuario(int idUsuario)
        {
            ...
            try
            {
                ...
                var cmd = new MySqlCommand
                {
                    CommandText = "select usuario, celular from UsuariosOnlineBroxel where id = " + idUsuario.ToString(CultureInfo.InvariantCulture) + ";",
                    Connection = _conn,
                    CommandType = CommandType.Text
                };
                var dr = cmd.ExecuteReader();
        ...
        public void UpdateCambioClabe(int idComercio)
        {
            try
            {
                _conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["MySQLBroxel_RDG"].ToString());
                _conn.Open();
                var sql = "update CambioClabe set estatus = 1 where idComercio = " + idComercio.ToString(CultureInfo.InvariantCulture);
                var cmd = new MySqlCommand
                {
                    CommandText = sql,
                    Connection = _conn,
