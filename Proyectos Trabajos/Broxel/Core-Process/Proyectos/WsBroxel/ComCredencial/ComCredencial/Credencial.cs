...
using ComCredencial.wsCuenta;
using ComCredencial.wsOperaciones;
using ComCredencial.GenericBL;

using Autenticacion = ComCredencial.wsCuenta.Autenticacion;
using ConsultarRequest = ComCredencial.wsCuenta.ConsultarRequest;
using ConsultarRequest1 = ComCredencial.wsCuenta.ConsultarRequest1;
using Originador = ComCredencial.wsCuenta.Originador;
using Autorizacion = ComCredencial.wsAutorizacion;
...
namespace ComCredencial
{
    public class Credencial
    {
        ...
        private SaldoResponse GetSaldosPorCuenta(String numeroCuenta, String idUsuario = "", String callerId = "null")
        {
            var ip = "Unknown";
            try
            {
