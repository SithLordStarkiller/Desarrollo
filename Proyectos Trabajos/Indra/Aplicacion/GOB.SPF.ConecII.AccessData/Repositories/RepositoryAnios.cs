    ...
    public class RepositoryAnios : IRepository<Anio>
    {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        anios.Identificador = Convert.ToInt32(reader["Anio"]);
                        anios.Nombre = Convert.ToString(reader["Anio"]);
        ...
        public int Insertar(Anio anios)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[0] = new SqlParameter() { Value = anios.Identificador, ParameterName = "@Anio" };
                parameters[1] = new SqlParameter() { Value = anios.DesAnio, ParameterName = "@DesAnio" };
        ...
        public int Actualizar(Anio anios)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[2] = new SqlParameter() { Value = anios.DesAnio, ParameterName = "@DesAnio" };
