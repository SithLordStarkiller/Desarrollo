...
namespace GOB.SPF.ConecII.Web.Models
{
    public class UiFactor : UiEntity
    {
        ...
        [DisplayName("Clasificador Factor*")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "El clasificador factor es requerido")]
        public List<UiTiposServicio> TiposServicio { get; set; }
        public int IdTipoServicio { get; set; }
        public string TipoServicio { get; set; }

        [DisplayName("Clasificador Factor*")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "El clasificador factor es requerido")]
        public List<UiClasificacionFactor> ClasificacionFactor { get; set; }
        ...
        public List<UiMedidaCobro> MedidasCobro { get; set; }
        ...
        public decimal CuotaFactor { get; set; }
