...
{
    public class ContratantesUIController : ControllerCrud<Contratantes, ContratantesDtoBuscar>
    {
        #region Members
        ...
        public ContratantesUIController()
        {
            ControllerName = "Contratantes";
        }
        ...
        public override ActionResult Index([Bind(Include = "IdContratante, IdTipoDocumento, Nombre, Cargo, Domicilio, FechaInicial, FechaFinal, Activo")]Contratantes item, ContratantesDtoBuscar find)
        {
            TryUpdateModel(item, new[] { "IdContratante", "IdTipoDocumento", "Nombre", "Cargo", "Domicilio", "FechaInicial", "FechaFinal", "Activo"});//regrese un bool
        ...
        public override PartialViewResult AddModifyItem(ContratantesDtoBuscar find)
        {
            CargarDropTiposDocumento();
