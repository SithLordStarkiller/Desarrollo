Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            factorLeyIngreso: new controls.Grid('divFactorLeyIngreso', { maxHeight: 400, pager: { show: true, pageSize: 3, currentPage: 1, pages: 2 }, showPlusButton: true })
        },
        buttons: {
            create: $("#btnCreate"),
    ...
    var columns = [{ text: 'No.', iskey: true, css: 'col-xs-1', visible: true },
        { text: 'Año', field: 'IdAnio', css: 'col-xs-3' },
        { text: 'Mes', field: 'Mes', css: 'col-xs-3' },
        { text: 'Factor', field: 'Factor', css: 'col-xs-3' },
            ...
            $('#btnSave').on('click', function () {
                ...
                if ($("#factorLeyIngresoForm").valid()) {
                    var data = {
                        ObjectResult: {
                            IdAnio: $("#Anios").val(),
                            Anio: $("#Anios option:selected").text(),
                            IdMes: $("#Meses").val(),
                            Mes: $("#Meses option:selected").text(),
                            Factor: $("#Factor").val(),
