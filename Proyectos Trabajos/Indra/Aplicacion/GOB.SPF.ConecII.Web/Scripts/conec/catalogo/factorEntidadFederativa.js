Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            factorEntidadFederativa: new controls.Grid('divFactorEntidadFederativa', { maxHeight: 400, pager: { show: true, pageSize: 3, currentPage: 1, pages: 2 }, showPlusButton: true })
        },
        buttons: {
            create: $("#btnCreate"),
