namespace GOB.SPF.ConecII.Business
{
    ...
    public class CuotasBusiness
    {
        ...
        public IEnumerable<Cuota> ObtenerTodosConceptos(Paging paging)
        {
            using (var uow = UnitOfWorkFactory.Create())
            {
                var repositoryCoutas = new RepositoryCuotas(uow);
                return repositoryCoutas.ObtenerConceptos(paging);
            }
        }

        public IEnumerable<Cuota> ObtenerTodosAnos(Paging paging)
        {
            using (var uow = UnitOfWorkFactory.Create())
            {
                var repositoryCoutas = new RepositoryCuotas(uow);
