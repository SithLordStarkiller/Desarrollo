Ui.prototype.init = function () {
    ...
    this.urls = {
        ...
        ObtenerReceptores: this.getUrl('/Configuracion/ObtenerReceptores'),
...
Ui.prototype.load = function (evt) {
    ...
    var pageReceptor = self.controls.grids.GridReceptor.currentPage;
    var rowsReceptor = self.controls.grids.GridReceptor.pageSize;
    var loadReceptor = function (data) {
        self.controls.grids.GridReceptor.loadRows([]);
        if (data.Result) {
            self.controls.grids.GridReceptor.currentPage = pageReceptor;
            self.controls.grids.GridReceptor.pages = rowsReceptor;
            self.controls.grids.GridReceptor.loadRows(data.List);
        }

    };
    var dataGridReceptor = {
        Message: $("#IdNotificacion").val()
        , Paging: {
            CurrentPage: self.controls.grids.GridReceptor.currentPage,
            Rows: self.controls.grids.GridReceptor.pageSize
        }
    ...
    this.SendAjaxGrid('POST', self.urls.ObtenerReceptores, 'json', dataGridReceptor, loadReceptor);
};
...
$(document).ready(function () {
    ...
    $("#btnCrearNotificacion").click(function () {
        var notificacion = {
            ...
            CuerpoNotificacin: txaCuerpoNotificacion.value,
