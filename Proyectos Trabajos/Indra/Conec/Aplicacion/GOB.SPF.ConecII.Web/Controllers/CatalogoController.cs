namespace GOB.SPF.ConecII.Web.Controllers
{
    ...
    public class CatalogoController : Controller
    {
        ...
        public JsonResult ObtenerAnios(string term)
        {
            ...
            var queryA = AnioList.List.Where(x => x.Anios.ToString().Contains(term)).Select(x => new { id = x.Identificador, value = x.Anios }).OrderBy(x => x.value).ToList();
        ...
        public async Task<PartialViewResult> FactorMunicipio(UiFactorMunicipio model)
        {
            ...
            switch (model.Action)
            {
                ...
                case UiEnumEntity.Edit:
                    ViewBag.Title = "Modificar Municipio";
                    // se llenan los DropDownList
        ...
        public ActionResult FactorLeyIngresos()
        {
            ...
            var query = aniosList.Select(x => new { x.Identificador, Name=x.Anios }).OrderBy(x => x.Name).ToList();
        ...
        public async Task<PartialViewResult> FactorLeyIngreso(UiFactorLeyIngreso model)
        {
            ...
            var queryA = AnioList.List.Select(x => new { x.Identificador, x.Anios }).OrderBy(x => x.Identificador).ToList();
        ...
        public ActionResult Factores()
        {
            ...
            factoresList.List = clientService.ObtenerFactor(1, 20);
