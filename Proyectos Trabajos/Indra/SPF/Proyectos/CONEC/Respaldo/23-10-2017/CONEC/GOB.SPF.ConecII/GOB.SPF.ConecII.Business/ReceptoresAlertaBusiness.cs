namespace GOB.SPF.ConecII.Business
{
    ...
    public class ReceptoresAlertaBusiness
    {
        ...
        public bool ActualizarListaReceptorAlerta(List<ReceptorAlerta> entity, Notificaciones notificacion)
        {
            bool result;
            ...
            using (var uow = UnitOfWorkFactory.Create())
            {
                ...
                result = repositoryReceptoresAlertas.ActualizarListaReceptorAlerta(dataTable, notificacion);
