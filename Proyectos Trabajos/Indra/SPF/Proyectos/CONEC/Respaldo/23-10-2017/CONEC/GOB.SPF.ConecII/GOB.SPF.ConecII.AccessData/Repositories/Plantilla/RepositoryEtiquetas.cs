...
    {
        ...
        public override IEnumerable<Etiquetas> Obtener(IPaging paging)
        {
        ...
        public override IEnumerable<Etiquetas> ObtenerPorCriterio(IPaging paging, Etiquetas busqueda)
        {
            var result = new List<Etiquetas>();
