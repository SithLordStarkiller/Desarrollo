    ...
    public class RepositoryAreasValidadoras : IRepository<AreasValidadoras>
    {
        ...
        public int CambiarEstatus(AreasValidadoras entity)
        {
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                cmd.Parameters.Add(new SqlParameter { Value = entity.IdTipoServicio, ParameterName = "@IdTipoServicio" });
                cmd.Parameters.Add(new SqlParameter { Value = entity.EsActivo, ParameterName = "@Activo" });
        ...
        public IEnumerable<AreasValidadoras> ObtenerPorCriterio(IPaging paging, AreasValidadoras entity)
        {
            throw new NotImplementedException();
        }
        ...
        public bool InsertarTabla(DataTable table)
        {
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                cmd.Parameters.Add(new SqlParameter { Value = table, ParameterName = "@Tabla", SqlDbType = SqlDbType.Structured });
