...
namespace GOB.SPF.ConecII.AccessData.Repositories.Plantilla
{
    public partial class RepositoryContratantes : Repository<Contratantes>
    {
        ...
        public override IEnumerable<Contratantes> Obtener(IPaging paging)
        {
        ...
        public override IEnumerable<Contratantes> ObtenerPorCriterio(IPaging paging, Contratantes busqueda)
        {
            var result = new List<Contratantes>();
