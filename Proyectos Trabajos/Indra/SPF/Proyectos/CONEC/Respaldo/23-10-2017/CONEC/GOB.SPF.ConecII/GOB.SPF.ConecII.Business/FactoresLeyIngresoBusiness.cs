...
namespace GOB.SPF.ConecII.Business
{
    ...
    public class FactoresLeyIngresoBusiness
    {
        ...
        public IEnumerable<FactorLeyIngreso> ObtenerTodos(IPaging paging)
        {
            using (var uow = UnitOfWorkFactory.Create())
            {
                var repositoryFactorLeyIngreso = new RepositoryFactoresLeyIngreso(uow);
        ...
        public IEnumerable<FactorLeyIngreso> ObtenerPorCriterio(IPaging paging, FactorLeyIngreso entity)
        {
            using (var uow = UnitOfWorkFactory.Create())
            {
                var repositoryFactorLeyIngreso = new RepositoryFactoresLeyIngreso(uow);
