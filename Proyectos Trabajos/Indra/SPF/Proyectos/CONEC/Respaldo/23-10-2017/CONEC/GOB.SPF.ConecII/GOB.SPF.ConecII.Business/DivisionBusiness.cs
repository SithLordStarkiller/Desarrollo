...
namespace GOB.SPF.ConecII.Business
{
    ...
    public class DivisionBusiness
    {
        ...
        public IEnumerable<Division> ObtenerTodos(IPaging paging)
        {
        ...
        {
            int result = 0;
            Division division = ObtenerPorId(entity.Identificador);
            string messageValidation = ValidacionRegistro(division);
        ...
        public IEnumerable<Division> ObtenerPorCriterio(IPaging paging, Division entity)
        {
