Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            modulo: new controls.Grid('divModulo', { maxHeight: 400, pager: { show: true, pageSize: 20, currentPage: 1, pages: 1 }, showPlusButton: true })
        },
        buttons: {
            create: $("#btnCreate"),
    ...
    var columns = [
                    ...
                    { text: '', field: 'Descripcion', css: 'col-xs-1', id:"Prueba",cellType: { type: cons.cellType.BUTTON, cssClass: { normal: 'Edit' } } },
