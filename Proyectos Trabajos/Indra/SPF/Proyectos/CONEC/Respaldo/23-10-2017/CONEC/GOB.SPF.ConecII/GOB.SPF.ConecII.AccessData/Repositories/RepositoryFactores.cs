...
namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryFactores : IRepository<Factor>
    {
        ...
        public IEnumerable<Factor> Obtener(IPaging paging)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        factores.Nombre = Convert.ToString(reader["Nombre"]);
                        factores.Descripcion = Convert.ToString(reader["Descripcion"]);
                        factores.Cuota = Convert.ToDecimal(reader["Cuota"]);
                        factores.CuotaTexto = Convert.ToString(reader["Cuota"]);
        ...
        public int Insertar(Factor factores)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[5] = new SqlParameter() { Value = Convert.ToDouble(factores.Cuota), ParameterName = "@CuotaFactor" };
        ...
        public int Actualizar(Factor factores)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[6] = new SqlParameter() { Value = Convert.ToDouble(factores.Cuota), ParameterName = "@CuotaFactor" };
        ...
        public IEnumerable<Factor> ObtenerPorCriterio(IPaging paging, Factor entity)
        {
            var result = new List<Factor>();
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                cmd.Parameters.Add(new SqlParameter() { Value = entity.Identificador, ParameterName = "@IdFactor" });
                cmd.Parameters.Add(new SqlParameter() { Value = entity.IdTipoServicio, ParameterName = "@IdTipoServicio" });
                cmd.Parameters.Add(new SqlParameter() { Value = entity.IdClasificacionFactor, ParameterName = "@IdClasificacionFactor" });
        ...
        public IEnumerable<Factor> ClasificacionObtieneFactor(RequestFactor entity)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                cmd.CommandText = Factores.ClasificacionObtieneFactor;
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add(new SqlParameter() { Value = entity.Item.IdClasificacionFactor, ParameterName = "@IdClasificacion" });
        ...
        public IEnumerable<Factor> ClasificacionObtieneFactorMunicipios(RequestFactor entity)
        {
            var result = new List<Factor>();

            using (var cmd = _unitOfWork.CreateCommand())
            {
                cmd.CommandText = Factores.ClasificacionObtieneFactorMunicipios;
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string ValidarRegistro(Factor factores)
        {
            string result = "";

            using (var cmd = _unitOfWork.CreateCommand())
            {
                cmd.CommandText = Factores.FactoresValidarRegistro;
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                parameters[2] = new SqlParameter() { Value = factores.IdClasificacionFactor, ParameterName = "@IdClasificacionFactor" };
                parameters[3] = new SqlParameter() { Value = factores.Nombre, ParameterName = "@Factor" };
                parameters[4] = new SqlParameter() { Value = factores.FechaAutorizacion, ParameterName = "@FechaAutorizacion" };
                parameters[5] = new SqlParameter() { Value = factores.FechaEntradaVigor, ParameterName = "@FechaEntradaVigor" };
                parameters[6] = new SqlParameter() { Value = factores.FechaTermino, ParameterName = "@FechaTermino" };
                parameters[7] = new SqlParameter() { Value = factores.FechaPublicacionDof, ParameterName = "@FechaPublicacionDof" };
