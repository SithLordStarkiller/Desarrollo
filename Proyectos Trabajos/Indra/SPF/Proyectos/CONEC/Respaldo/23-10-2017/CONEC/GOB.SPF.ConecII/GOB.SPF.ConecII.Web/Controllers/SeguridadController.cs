...
namespace GOB.SPF.ConecII.Web.Controllers
{
    ...
    public class SeguridadController : Controller
    {
        ...
        public ActionResult AdminPermisos()
        {
            var roles = new List<Roles>
            {
                new Roles { IdRol = 0, NombreRol = "Selecciona un Rol" },
            ...
            {
                new UiMenu { Identificador = 0, Nombre = "Selecciona un menu"}
            };


            var listaMenus = menus.Select(c => new SelectListItem
            {
                Value = c.Identificador.ToString(),
                Text = c.Nombre,
                Selected = c.Identificador == 0
        ...
        public PartialViewResult AdminPermiso(UiPermisosRol model)
        {
            var roles = new List<Roles>
            {
                new Roles { IdRol = 0, NombreRol = "Selecciona un Rol" },
        ...
        public JsonResult AdminPermisosConsultar(UiResultPage<UiPermisosRol> model)
        {
