Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            fraccion: new controls.Grid('divFraccion', { maxHeight: 400, pager: { show: true, pageSize: 10, currentPage: 0}, showPlusButton: true })
        },
        buttons: {
            create: $("#btnCreate"),
    ...
    $("#Division").select2().change(function () {
        var destino = document.getElementById("Fraccion");
        if (this.value !== "") {
            $.get(self.urls.fracciones + this.value, function (data) {
                switch (data.Result) {
                    case 1:
