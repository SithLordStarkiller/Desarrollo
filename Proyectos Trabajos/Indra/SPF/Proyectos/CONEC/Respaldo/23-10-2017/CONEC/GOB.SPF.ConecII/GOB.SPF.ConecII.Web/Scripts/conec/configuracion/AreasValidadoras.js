Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            GridAreasValidadoras: new controls.Grid('divAreasValidadoras', { maxHeight: 400, pager: { show: true, pageSize: 10, currentPage: 1 }, showPlusButton: true })
        },
        buttons: {
            create: $("#btnCreate"),
    ...
    this.controls.grids.GridAreasValidadoras.addListener("onButtonClick", function (evt) {
        ...
        switch (evt.event) {
            ...
            case 'Inactive':
                ...
                object.EsActivo = !object.EsActivo;
