Ui.prototype.init = function () {
    ...
    $(this.controls.buttons.AgregarRol).click(function () {
        ...
        if (rol === "0" || rol === "") {
            ...
            var loadGridReceptor = function (data) {
                ...
                if (data.Result) {
                    self.controls.grids.GridReceptor.reload(data.List);
    ...
    this.loadGirdReceptores();
};

Ui.prototype.loadGirdReceptores = function (evt) {
    var self = this;
    ...
    var data = { model: { Message: $("#IdNotificacion").val() } };

    this.SendAjax('POST', self.urls.ObtenerReceptores, 'json', data, loadGrid);
};
...
Ui.prototype.load = function (evt) {
    ...
    $("#btnActualizarNotificacion").click(function () {
        var notificacion = {
        ...
        $.ajax({
            type: 'POST',
            url: '/Configuracion/ActualizarNotificacion',
            dataType: 'json',
