...
namespace GOB.SPF.ConecII.Business
{
    ...
    public class FactoresMunicipioBusiness
    {
        ...
        public IEnumerable<FactorMunicipioDTO> ObtenerTodos(IPaging paging)
        {
        ...
        public IEnumerable<FactorMunicipioDTO> ObtenerPorCriterio(IPaging paging, FactorMunicipio entity)
        {
            List<FactorMunicipioDTO> result = new List<FactorMunicipioDTO>();
            FactorMunicipioDTO dto = new FactorMunicipioDTO();
            using (var uow = UnitOfWorkFactory.Create())
        ...
        public FactorMunicipioDTO Obtener(IPaging paging)
        {
            FactorMunicipioDTO dto = new FactorMunicipioDTO();
        ...
        public IEnumerable<FactorMunicipioDTO> ObtenerAgrupado(IPaging paging)
        {
            List<FactorMunicipioDTO> result = new List<FactorMunicipioDTO>();
            FactorMunicipioDTO dto = new FactorMunicipioDTO();
            using (var uow = UnitOfWorkFactory.Create())
