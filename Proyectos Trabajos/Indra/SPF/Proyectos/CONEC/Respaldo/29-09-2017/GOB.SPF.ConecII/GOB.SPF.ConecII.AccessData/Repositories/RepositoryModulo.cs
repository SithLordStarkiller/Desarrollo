    ...
    public class RepositoryModulo : IRepository<Modulo>
    {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        Modulo.Enlace = reader["Enlace"].ToString();
        ...
        public int Insertar(Modulo Modulo)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                cmd.Parameters.Add(new SqlParameter() { Value = Modulo.Enlace, ParameterName = "@Enlace" });
        ...
        public int Actualizar(Modulo Modulo)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[4] = new SqlParameter() { Value = Modulo.Descripcion, ParameterName = "@Enlace" };
