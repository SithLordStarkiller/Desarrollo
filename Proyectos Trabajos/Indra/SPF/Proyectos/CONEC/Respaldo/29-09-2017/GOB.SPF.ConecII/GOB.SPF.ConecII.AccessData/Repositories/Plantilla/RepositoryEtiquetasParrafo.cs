...
namespace GOB.SPF.ConecII.AccessData.Repositories.Plantilla
{
    public partial class RepositoryEtiquetasParrafo : Repository<EtiquetasParrafo>
    {
        ...
        public override IEnumerable<EtiquetasParrafo> Obtener(Paging paging)
        {
        ...
        public override IEnumerable<EtiquetasParrafo> ObtenerPorCriterio(Paging paging, EtiquetasParrafo busqueda)
        {
            var result = new List<EtiquetasParrafo>();
        ...
        public List<EtiquetasParrafo> ObtenerPorIdParteDocumento(Paging paging, EtiquetasParrafo busqueda)
        {
            var result = new List<EtiquetasParrafo>();
