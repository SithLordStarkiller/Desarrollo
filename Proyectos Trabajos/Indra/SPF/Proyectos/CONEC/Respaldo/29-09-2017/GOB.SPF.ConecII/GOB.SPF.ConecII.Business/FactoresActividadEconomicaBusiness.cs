namespace GOB.SPF.ConecII.Business
{
    ...
    public class FactoresActividadEconomicaBusiness
    {
        ...
        public IEnumerable<FactorActividadEconomicaDTO> ObtenerTodos(Paging paging)
        {
        ...
        public IEnumerable<FactorActividadEconomica> ObtenerSinAgrupar(Paging paging)
        {
            using (var uow = UnitOfWorkFactory.Create())
            {
                var repositoryFactoresActividadEconomica = new RepositoryFactoresActividadEconomica(uow);
        ...
        public IEnumerable<FactorActividadEconomicaDTO> ObtenerAgrupado(Paging paging)
        {
            List<FactorActividadEconomicaDTO> result = new List<FactorActividadEconomicaDTO>();
            FactorActividadEconomicaDTO dto = new FactorActividadEconomicaDTO();
            using (var uow = UnitOfWorkFactory.Create())
        ...
        public IEnumerable<FactorActividadEconomicaDTO> ObtenerPorCriterio(Paging paging, FactorActividadEconomica entity)
        {
            List<FactorActividadEconomicaDTO> result = new List<FactorActividadEconomicaDTO>();
            FactorActividadEconomicaDTO dto = new FactorActividadEconomicaDTO();
            using (var uow = UnitOfWorkFactory.Create())
