Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            tipoDocumento: new controls.Grid('divTipoDocumento', { maxHeight: 400, pager: { show: true, pageSize: 20, currentPage: 1, pages: 1 }, showPlusButton: true })
    ...
    //$("#TipoDocumento").select2().change(function () {
    //    var destino = document.getElementById("TipoDocumento");
    //    if (this.value !== "") {
