...
namespace GOB.SPF.Conec.Services.Tests
{
    ...
    public class UnitTest1
    {
        ...
        public void TestGuardarFactoresLeyIngreso()
        {
            ...
            //entity.NombreLI = "P/"+strTestName;
            //entity.DescLI = "Test desde proyecto de pruebas, la fecha de creación:"+strTestName;
            entity.IdAnio = 1;
            entity.IdMes = 2;
            entity.Factor = 15;
            entity.FechaInicial = dtTest.AddDays(1);
        ...
        public void TestGuardarFactoresActividadEconomica()
        {
            ...
            FactorActividadEconomica entities = new FactorActividadEconomica();
            ...
            List<FactorActividadEconomicaDTO> listaGuardados = negocioFactoresActividadEconomica.ObtenerPorCriterio(paging, entities).ToList();
        ...
        public void TestUpdateFactoresActividadEconomica()
        {
            ...
            List<FactorActividadEconomicaDTO> listaGuardados = negocioFactoresActividadEconomica.ObtenerTodos(paging).ToList();
