...
namespace GOB.SPF.Conec.Services.Controllers
{
    ...
    public class CatalogController : ApiController
    {
        ...
        #region ROLES
        [HttpPost]
        [Route("Roles/ObtenerTodos")]
        public IHttpActionResult RolesObtener(RequestRol entity)
        {
            ResultPage<Rol> result = new ResultPage<Rol>();
            try
            {
                business.RolBusiness business = new business.RolBusiness();
                result.List.AddRange(business.ObtenerTodos(entity.Paging));
                result.Page.CurrentPage = entity.Paging.CurrentPage;
                result.Page.Pages = business.Pages;
                result.Success = true;
        ...
        //eliminado porque ya existen 2 más
        //[HttpPost]
        //[Route("Roles/ObtenerListado")]
        //public IHttpActionResult RolesObtenerListado()
        //{
        //    ResultPage<Rol> result = new ResultPage<Rol>();
        //    try
        //    {
        ...
        [HttpPost]
        [Route("Roles/ObtenerPorCriterio")]
        public IHttpActionResult RolesObtenerPorCriterio(RequestRol entity)
        {
            ResultPage<Rol> result = new ResultPage<Rol>();
            try
            {
        ...
        [HttpPost]
        [Route("Roles/ObtenerPorId/{id}")]
        public async Task<IHttpActionResult> RolObtenerPorId(RequestRol entity)
        {
            ResultPage<Rol> result = new ResultPage<Rol>();
            try
            {
        ...
        [HttpPost]
        [Route("Roles/CambiarEstatus")]
        public async Task<IHttpActionResult> RolCambiarEstatus(RequestRol entity)
        {
            ResultPage<Rol> result = new ResultPage<Rol>();
            try
            {
        ...
        [HttpPost]
        [Route("Roles/Save")]
        public IHttpActionResult RolGuardar(RequestRol entity)
        {
            ResultPage<Rol> result = new ResultPage<Rol>();
            try
            {
        ...
        #region MODULOS
        [HttpPost]
        [Route("Modulos/ObtenerTodos")]
        public IHttpActionResult ModulosObtener(RequestModulo entity)
        {

            ResultPage<Modulo> result = new ResultPage<Modulo>();
            try
            {
                business.ModuloBusiness business = new business.ModuloBusiness();
                result.List.AddRange(business.ObtenerTodos(entity.Paging));
                result.Page.CurrentPage = entity.Paging.CurrentPage;
                result.Page.Pages = business.Pages;
                result.Success = true;
        ...
        //eliminado porque ya existen 2 más
        //[HttpPost]
        //[Route("Modulos/ObtenerListado")]
        //public IHttpActionResult ModulosObtenerListado()
        //{
        //    ResultPage<Modulo> result = new ResultPage<Modulo>();
        //    try
        //    {
        ...
        [HttpPost]
        [Route("Modulos/ObtenerPorCriterio")]
        public IHttpActionResult ModulosObtenerPorCriterio(RequestModulo entity)
        {
            ResultPage<Modulo> result = new ResultPage<Modulo>();
            try
            {
        ...
        [HttpPost]
        [Route("Modulos/ObtenerPorId/{id}")]
        public async Task<IHttpActionResult> ModuloObtenerPorId(RequestModulo entity)
        {
            ResultPage<Modulo> result = new ResultPage<Modulo>();
            try
            {
        ...
        [HttpPost]
        [Route("Modulos/CambiarEstatus")]
        public async Task<IHttpActionResult> ModuloCambiarEstatus(RequestModulo entity)
        {
            ResultPage<Modulo> result = new ResultPage<Modulo>();
            try
            {
        ...
        [HttpPost]
        [Route("Modulos/Save")]
        public IHttpActionResult ModuloGuardar(RequestModulo entity)
        {
            ResultPage<Modulo> result = new ResultPage<Modulo>();
            try
            {
        ...
        [HttpPost]
        [Route("Cuotas/ObtenerTodosConceptos")]
        public async Task<IHttpActionResult> ObtenerTodosConceptos(RequestCuota entity)
        {
            ...
            {
                business.CuotasBusiness business = new business.CuotasBusiness();
                result.List.AddRange(business.ObtenerTodosConceptos(entity.Paging));
                result.Page.CurrentPage = entity.Paging.CurrentPage;
                result.Page.Pages = business.Pages;
                result.Success = true;
            }
