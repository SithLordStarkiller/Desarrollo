...
namespace GOB.SPF.Conec.Services.Controllers.Tests
{
    ...
    public class CatalogControllerTests
    {
        ...
        [TestMethod]
        public void TestSaveAndUpdateFactorEntidadFederativa()
        {
            var dtTest = DateTime.Now;
            var strTestName = DateTime.Now.ToShortDateString();

            FactorEntidadFederativaDTO entity = new FactorEntidadFederativaDTO();

            entity.Identificador = 3;
            entity.Descripcion = "Test desde proyecto de pruebas, actualizacion, el nombre es igual a la fecha de creación";
            entity.Clasificacion = new ClasificacionFactor { Identificador = 1 };
            entity.Factor = new Factor { Identificador = 1 };
            entity.Estados.Add(new Estado { Identificador = 1 });
            entity.Estados.Add(new Estado { Identificador = 2 });
            entity.Estados.Add(new Estado { Identificador = 3 });
            entity.Activo = true;
            Paging paging = new Paging { All = true, CurrentPage = 1, Rows = 20 };
            negocioFactoresEntidadFederativa.Guardar(entity);

        }

        [TestMethod()]
        public void TestObtenerTodosFactorEntidadFederativa()
        {
            var entity = new RequestFactorEntidadFederativa
            {
                Paging = new Paging { All = true, CurrentPage = 1, Rows = 10 }
            };
            ConecII.Business.FactoresEntidadFederativaBusiness business = new ConecII.Business.FactoresEntidadFederativaBusiness();
            var lista = business.ObtenerSinAgrupar(entity.Paging);

            Assert.IsTrue(lista.Any());
        }

        [TestMethod()]
        public void TestObtenerPorCriterioFactorEntidadFederativa()
        {
            var entity = new RequestFactorEntidadFederativa
            {
                Paging = new Paging { All = true, CurrentPage = 1, Pages = 10, Rows = 10 },
                Item = new FactorEntidadFederativa { Activo = true }
            };
            ConecII.Business.FactoresEntidadFederativaBusiness business = new ConecII.Business.FactoresEntidadFederativaBusiness();
            var lista = business.ObtenerPorCriterio(entity.Paging, entity.Item);
        ...
        [TestMethod()]
        public void TestObtenerIdFactorEntidadFederativa()
        {
            ConecII.Business.FactoresEntidadFederativaBusiness business = new ConecII.Business.FactoresEntidadFederativaBusiness();
            var objeto = business.ObtenerPorId(1);
        ...
        [TestMethod]
        public void TestSaveAndUpdateFactorActividadEconomica()
        {
            var dtTest = DateTime.Now;
            var strTestName = DateTime.Now.ToShortDateString();

            FactorActividadEconomicaDTO entity = new FactorActividadEconomicaDTO();

            entity.Identificador = 3;
            entity.Descripcion = "Test desde proyecto de pruebas, actualizacion, el nombre es igual a la fecha de creación";
            entity.Clasificacion = new ClasificacionFactor { Identificador = 1 };
            entity.Factor = new Factor { Identificador = 1 };
            entity.Fracciones.Add(new Fraccion { Identificador = 1 });
            entity.Fracciones.Add(new Fraccion { Identificador = 2 });
            entity.Fracciones.Add(new Fraccion { Identificador = 3 });
            entity.Activo = true;
            Paging paging = new Paging { All = true, CurrentPage = 1, Rows = 20 };
        ...
        [TestMethod()]
        public void TestObtenerTodosFactorActividadEconomica()
        {
            var entity = new RequestFactorActividadEconomica
            {
                Paging = new Paging { All = true, CurrentPage = 1, Rows = 10 }
            };
            ConecII.Business.FactoresActividadEconomicaBusiness business = new ConecII.Business.FactoresActividadEconomicaBusiness();
            var lista = business.ObtenerSinAgrupar(entity.Paging);
        ...
        [TestMethod()]
        public void TestObtenerPorCriterioFactorActividadEconomica()
        {
            var entity = new RequestFactorActividadEconomica
            {
                Paging = new Paging { All = true, CurrentPage = 1, Pages = 10, Rows = 10 },
                Item = new FactorActividadEconomica { Activo = true }
            };
            ConecII.Business.FactoresActividadEconomicaBusiness business = new ConecII.Business.FactoresActividadEconomicaBusiness();
            var lista = business.ObtenerPorCriterio(entity.Paging, entity.Item);
        ...
        [TestMethod]
        public void TestSaveAndUpdateFactorMunicipio()
        {
            var dtTest = DateTime.Now;
            var strTestName = DateTime.Now.ToShortDateString();

            FactorMunicipioDTO entity = new FactorMunicipioDTO();

            entity.Identificador = 3;
            entity.Descripcion = "Test desde proyecto de pruebas, actualizacion, el nombre es igual a la fecha de creación";
            entity.Clasificacion = new ClasificacionFactor { Identificador = 1 };
            entity.Factor = new Factor { Identificador = 1 };
            entity.Estado = new Estado { Identificador = 1 };
            entity.Municipios.Add(new Municipio { Identificador = 1 });
            entity.Municipios.Add(new Municipio { Identificador = 2 });
            entity.Municipios.Add(new Municipio { Identificador = 3 });
            entity.Activo = true;
            Paging paging = new Paging { All = true, CurrentPage = 1, Rows = 20 };
            negocioFactoresMunicipio.Guardar(entity);

        }

        [TestMethod()]
        public void TestObtenerTodosFactorMunicipio()
        {
            var entity = new RequestFactorMunicipio
            {
                Paging = new Paging { All = true, CurrentPage = 1, Rows = 10 }
            };
            ConecII.Business.FactoresMunicipioBusiness business = new ConecII.Business.FactoresMunicipioBusiness();
            var lista = business.ObtenerAgrupado(entity.Paging);

            Assert.IsTrue(lista.Any());
        }

        [TestMethod()]
        public void TestObtenerPorCriterioFactorMunicipio()
        {
            var entity = new RequestFactorMunicipio
            {
                Paging = new Paging { All = true, CurrentPage = 1, Pages = 10, Rows = 10 },
                Item = new FactorMunicipio { Activo = true }
            };
            ConecII.Business.FactoresMunicipioBusiness business = new ConecII.Business.FactoresMunicipioBusiness();
            var lista = business.ObtenerPorCriterio(entity.Paging, entity.Item);
