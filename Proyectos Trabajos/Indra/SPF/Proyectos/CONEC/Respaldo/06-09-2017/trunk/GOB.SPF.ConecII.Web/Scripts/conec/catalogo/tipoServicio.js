Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            tipoServicio: new controls.Grid('divTiposServicio', { maxHeight: 400, pager: { show: true, pageSize: 20, currentPage: 1, pages: 1 }, showPlusButton: true })
        },
        buttons: {
            create: $("#btnCreate"),
    ...
    $(this.controls.buttons.buscar).click(function () {
        var data = {
            ObjectResult: {
                ...
                Identificador: $("#TipoServicioId").val(),
            }, Paging: {
