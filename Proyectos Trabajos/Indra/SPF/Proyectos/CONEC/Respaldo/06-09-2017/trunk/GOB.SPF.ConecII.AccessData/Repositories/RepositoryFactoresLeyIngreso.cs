    ...
    public class RepositoryFactoresLeyIngreso : IRepository<FactorLeyIngreso>
    {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        factoresLeyIngreso.Factor = Convert.ToDecimal(reader["Factor"]);
                        factoresLeyIngreso.FechaInicial = Convert.ToDateTime(reader["FechaInicial"]);
                        if (!(reader["FechaFinal"] == DBNull.Value))
                            factoresLeyIngreso.FechaFinal = Convert.ToDateTime(reader["FechaFinal"]);
        ...
        public int Insertar(FactorLeyIngreso factoresLeyIngreso)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[2] = new SqlParameter() { Value = factoresLeyIngreso.Factor, ParameterName = "@Factor" };
        ...
        public int Actualizar(FactorLeyIngreso factoresLeyIngreso)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[3] = new SqlParameter() { Value = factoresLeyIngreso.Factor, ParameterName = "@Factor" };
        ...
        public string ValidarRegistro(FactorLeyIngreso entity)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                parameters[1] = new SqlParameter() { Value = entity.IdAnio, ParameterName = "@Anio" };
