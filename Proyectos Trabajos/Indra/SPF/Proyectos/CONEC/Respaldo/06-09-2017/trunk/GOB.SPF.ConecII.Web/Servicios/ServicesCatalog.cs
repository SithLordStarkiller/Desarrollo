...
namespace GOB.SPF.ConecII.Web.Servicios
{
    internal class ServicesCatalog : IService
    {
        ...
        internal List<UiRol> RolesObtenerPorCriterio(int currentPage, int rows, UiRol objectResult)
        {
            throw new NotImplementedException();
        }

        public List<UiRol> RolesObtenerPorCriterio(int page, int rows, UiDivision model)
        {
            List<UiRol> list = new List<UiRol>(); ;
