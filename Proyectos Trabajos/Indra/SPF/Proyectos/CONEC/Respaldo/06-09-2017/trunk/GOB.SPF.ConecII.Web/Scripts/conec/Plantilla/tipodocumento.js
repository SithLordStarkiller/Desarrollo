Ui.prototype.init = function () {
    ...
    this.urls = {
        tiposDocumento: this.getUrl('/TiposDocumento/Consulta'),
        tipoDocumento: this.getUrl('/TiposDocumento/'),
        guardar: this.getUrl('/TiposDocumento/Guardar'),
        cambiarestatus: this.getUrl('/TiposDocumento/CambiarEstatus'),
        buscar: this.getUrl('/TiposDocumento/ConsultaCriterio'),
    };
    this.controls = {
        grids: {
