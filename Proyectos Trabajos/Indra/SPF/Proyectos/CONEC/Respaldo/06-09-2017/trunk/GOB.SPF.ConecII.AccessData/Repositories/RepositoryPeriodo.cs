namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryPeriodo : IRepository<Periodo>
    {
        ...
        public IEnumerable<Periodo> Obtener(Paging paging)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        //Periodos.FechaInicial = Convert.ToDateTime(reader["FechaInicial"]);
                        //Periodos.FechaFinal = Convert.ToDateTime(reader["FechaFinal"]);
