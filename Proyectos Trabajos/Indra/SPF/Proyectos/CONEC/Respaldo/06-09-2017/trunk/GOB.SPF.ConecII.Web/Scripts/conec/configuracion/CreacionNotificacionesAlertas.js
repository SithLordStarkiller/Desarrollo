Ui.prototype.init = function () {
    ...
    this.controls = {
        grids: {
            ...
            GridIntegrantes: new controls.Grid('divIntegrantes', { maxHeight: 400, pager: { show: true, pageSize: 10, currentPage: 1, pages: 1 } }),
            GridReceptor: new controls.Grid('divReceptor', { maxHeight: 400, pager: { show: true, pageSize: 10, currentPage: 1, pages: 1 } })
        },
        buttons: {
