...
namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryTiposServicio : IRepository<TipoServicio>
    {
        ...
        public IEnumerable<TipoServicio> Obtener(IPaging paging)
        {
        ...
        public IEnumerable<TipoServicio> ObtenerPorCriterio(IPaging paging, TipoServicio entity)
        {
            var result = new List<TipoServicio>();
        ...
        public string ValidarRegistro(TipoServicio tServicio)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                cmd.CommandText = Catalogos.TipoServicioValidarRegistro;
                cmd.CommandType = CommandType.StoredProcedure;
