...
namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryReferencias : IRepository<Referencia>
    {
        ...
        public IEnumerable<Referencia> Obtener(IPaging paging)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        referencias.EsProducto = Convert.ToBoolean(reader["EsProducto"]);
        ...
        public int Insertar(Referencia entity)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                cmd.Parameters.Add(new SqlParameter() { Value = entity.EsProducto, ParameterName = "@EsProducto" });
