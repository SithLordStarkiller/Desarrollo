...
namespace GOB.SPF.ConecII.AccessData.Repositories
{
    ...
    public class RepositoryUsuario : IRepository<Entities.Usuario>
    {
        ...
        public IEnumerable<Entities.Usuario> Obtener(IPaging paging)
        {
        ...
        public IEnumerable<Entities.Usuario> ObtenerPorCriterio(IPaging paging, Entities.Usuario entity)
        {
            var result = new List<Entities.Usuario>();
