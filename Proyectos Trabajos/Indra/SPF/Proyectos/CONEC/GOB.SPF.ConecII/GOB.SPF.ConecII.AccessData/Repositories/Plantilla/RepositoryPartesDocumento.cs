...
namespace GOB.SPF.ConecII.AccessData.Repositories.Plantilla
{
    public partial class RepositoryPartesDocumento : Repository<PartesDocumento>
    {
        ...
        public override IEnumerable<PartesDocumento> Obtener(IPaging paging)
        {
        ...
        public override IEnumerable<PartesDocumento> ObtenerPorCriterio(IPaging paging, PartesDocumento busqueda)
        {
            var result = new List<PartesDocumento>();
