...
namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryGastosInherentes : IRepository<GastoInherente>
    {
        ...
        public IEnumerable<GastoInherente> Obtener(IPaging paging)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        gastosInherentes.Identificador = Convert.ToInt32(reader["IdGastosInherentes"]);
        ...
        public IEnumerable<GastoInherente> ObtenerPorCriterio(IPaging paging, GastoInherente entity)
        {
            var result = new List<GastoInherente>();
