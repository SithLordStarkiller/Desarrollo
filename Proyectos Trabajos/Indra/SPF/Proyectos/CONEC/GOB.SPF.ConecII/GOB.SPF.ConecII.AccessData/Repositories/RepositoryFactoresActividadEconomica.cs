...
namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryFactoresActividadEconomica : IRepository<FactorActividadEconomica>
    {
        ...
        public IEnumerable<FactorActividadEconomica> Obtener(IPaging paging)
        {
        ...
        public IEnumerable<FactorActividadEconomica> ObtenerPorCriterio(IPaging paging, FactorActividadEconomica entity)
        {
            var result = new List<FactorActividadEconomica>();
