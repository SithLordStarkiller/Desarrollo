...
namespace GOB.SPF.ConecII.AccessData.Repositories
{
    ...
    public class RepositoryConfiguracionServicio : IRepository<ConfiguracionServicio>
    {
        ...
        public IEnumerable<ConfiguracionServicio> ObtenerPorCriterio(IPaging paging, ConfiguracionServicio entity)
        {
        ...
        public IEnumerable<ConfiguracionServicioDTO> ObtenerPaginado(IPaging paging)
        {
            var result = new List<ConfiguracionServicioDTO>();
        ...
        IEnumerable<ConfiguracionServicio> IRepository<ConfiguracionServicio>.Obtener(IPaging paging)
        {
            throw new NotImplementedException();
        }

        IEnumerable<ConfiguracionServicio> IRepository<ConfiguracionServicio>.ObtenerPorCriterio(IPaging paging, ConfiguracionServicio entity)
        {
            throw new NotImplementedException();
        }
