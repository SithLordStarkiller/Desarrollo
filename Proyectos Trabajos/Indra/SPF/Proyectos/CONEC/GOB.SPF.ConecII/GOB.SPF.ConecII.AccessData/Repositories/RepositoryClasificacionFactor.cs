...
namespace GOB.SPF.ConecII.AccessData
{
    ...
    public class RepositoryClasificacionFactor : IRepository<ClasificacionFactor>
    {
        ...
        public IEnumerable<ClasificacionFactor> Obtener(IPaging paging)
        {
        ...
        public IEnumerable<ClasificacionFactor> ObtenerPorCriterio(IPaging paging, ClasificacionFactor entity)
        {
        ...
        public string ValidarRegistro(ClasificacionFactor clasificacionFactor)
        {
            string result = "";

            using (var cmd = _unitOfWork.CreateCommand())
            {
                cmd.CommandText = Catalogos.ClasificacionFactorValidarRegistro;
                cmd.CommandType = CommandType.StoredProcedure;
