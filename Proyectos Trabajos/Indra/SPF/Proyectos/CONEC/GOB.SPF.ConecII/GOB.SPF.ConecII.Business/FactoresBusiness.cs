...
namespace GOB.SPF.ConecII.Business
{
    ...
    public class FactoresBusiness
    {
        ...
        public IEnumerable<Factor> ObtenerTodos(IPaging paging)
        {
            using (var uow = UnitOfWorkFactory.Create())
            {
        ...
        public bool CambiarEstatus(Factor entity)
        {
            bool result = false;
            Factor factor = ObtenerPorId(entity.Identificador);
            string messageValidation = ValidacionRegistro(factor);
        ...
        public IEnumerable<Factor> ClasificacionObtieneFactorMunicipios(RequestFactor entity)
        {
            ...
            {
                var repositoryCoutas = new RepositoryFactores(uow);
                return repositoryCoutas.ClasificacionObtieneFactorMunicipios(entity);
            }
        }
