...
namespace GOB.SPF.ConecII.Business
{
    ...
    public class FactoresEntidadFederativaBusiness
    {
        ...
        public IEnumerable<FactorEntidadFederativaDTO> ObtenerTodos(IPaging paging)
        {
        ...
        public IEnumerable<FactorEntidadFederativaDTO> ObtenerAgrupado(IPaging paging)
        {
            List<FactorEntidadFederativaDTO> result = new List<FactorEntidadFederativaDTO>();
            FactorEntidadFederativaDTO dto = new FactorEntidadFederativaDTO();
            using (var uow = UnitOfWorkFactory.Create())
        ...
        public IEnumerable<FactorEntidadFederativa> ObtenerSinAgrupar(IPaging paging)
        {
        ...
        public FactorEntidadFederativaDTO Obtener(IPaging paging)
        {
            FactorEntidadFederativaDTO dto = new FactorEntidadFederativaDTO();
        ...
        public IEnumerable<FactorEntidadFederativaDTO> ObtenerPorCriterio(IPaging paging, FactorEntidadFederativa entity)
        {
            List<FactorEntidadFederativaDTO> result = new List<FactorEntidadFederativaDTO>();
            FactorEntidadFederativaDTO dto = new FactorEntidadFederativaDTO();
            using (var uow = UnitOfWorkFactory.Create())
