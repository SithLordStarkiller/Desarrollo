...
namespace GOB.SPF.Conec.Services.Controllers
{
    ...
    public class SeguridadController : ApiController
    {
        ...
        public IHttpActionResult ModulosObtenerPorCriterio([FromBody]Peticion<ConecII.Entities.Modulos.Modulo> modulo)
        {
        ...
        [AllowAnonymous]
        [AcceptVerbs("GET")]
        [Route("RolesModulosObtenerTodos")]
        public IHttpActionResult RolesModulosObtenerTodos()
        {
            try
            {
                return Ok(new RolModuloBusiness().ObtenerTodos());
            }
            catch (Exception ex)
            {
                return InternalServerError(ex);
        ...
        [AcceptVerbs("POST")]
        [AllowAnonymous]
        [Route("RolesModulosObtenerPorCriterio")]
        public IHttpActionResult RolesModulosObtenerPorCriterio([FromBody]Peticion<RolModulo> peticion)
        {
            Respuesta<IEnumerable<IRolModulo>> result = new Respuesta<IEnumerable<IRolModulo>>();
            try
            {
                result.Resultado = new RolModuloBusiness().ObtenerPorCriterio(peticion.Paginado, peticion.Solicitud);
                result.Paginado = peticion.Paginado;
                result.Exitoso = true;
            }
            catch (SqlException e)
            {
