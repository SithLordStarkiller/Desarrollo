Ui.prototype.init = function () {
    ...
    var columns = [{ text: 'No.', iskey: true, css: 'col-xs-1', visible: true },
        ...
        { text: 'Cuota', field: 'CuotaTexto', css: 'col-xs-1' },
        { text: 'Autorización', field: 'FechaAutorizacion', css: 'col-xs-2' },
        { text: 'Entrada Vigor', field: 'FechaEntradaVigor', css: 'col-xs-2' },
        { text: 'Término', field: 'FechaTermino', css: 'col-xs-2' },
        { text: 'Publicación', field: 'FechaPublicacionDof', css: 'col-xs-2' },
