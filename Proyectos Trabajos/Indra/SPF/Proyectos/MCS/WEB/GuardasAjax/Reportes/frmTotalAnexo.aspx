<%@ Page Title="" Language="C#" MasterPageFile="~/Generales/MasterPage.master" AutoEventWireup="true" CodeFile="frmTotalAnexo.aspx.cs" Inherits="Reportes_frmTotalAnexo" %>
                    ...
                    <tr runat="server" id="trParametros">
                        <td>
                            <table class="tamanio">
                                <tr>
                                    <td class="titulo">
                                        Reporte de Totales de Anexo</td>
                                </tr>
                                <tr>
                                    <td class="subtitulo">
