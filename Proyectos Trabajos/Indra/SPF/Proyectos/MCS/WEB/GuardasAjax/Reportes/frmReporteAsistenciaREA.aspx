<%@ Page Title="Módulo de Control de Servicios ::: Reporte de Asistencia - REA" Language="C#" MasterPageFile="~/Generales/MasterPage.master" 
AutoEventWireup="true" CodeFile="frmReporteAsistenciaREA.aspx.cs" Inherits="Reportes_frmReporteAsistenciaREA" %>
                                            ...
                                            <ContentTemplate>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="izq">
                                                            <asp:DropDownList ID="ddlEstatusAsistencia" runat="server" CssClass="texto">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
