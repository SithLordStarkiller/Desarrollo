<%@ Page  Title="Módulo de Control de Servicios ::: Reporte Movimiento del Personal" Language="C#" MasterPageFile="~/Generales/MasterPage.master" AutoEventWireup="true" CodeFile="frmRvReporteMasivo.aspx.cs" Inherits="Reportes_frmRvReporteMasivo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tamanio">
        <tr>
            <td class="titulo">
                Reporte del movimiento de personal en las instalaciones
            </td>
        </tr>
    </table>
    <br />
