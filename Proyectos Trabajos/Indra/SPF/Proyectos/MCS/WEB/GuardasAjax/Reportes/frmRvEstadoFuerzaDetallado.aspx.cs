...
public partial class Reportes_frmRvEstadoFuerzaDetallado : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptEstadoFuerzaDetallado";
    ...
    {
        Response.Redirect("~/Reportes/frmEstadoFuerzaDetallado.aspx");
    }
}