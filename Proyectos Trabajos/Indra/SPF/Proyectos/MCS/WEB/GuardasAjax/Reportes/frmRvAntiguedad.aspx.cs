...
public partial class Reportes_frmRvAntiguedad : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptDiasAsignacion";
            ...
            parametrosReportes.Add(new ReportParameter("idZona", objReporte.Zona.IdZona == 0 ? null : objReporte.Zona.IdZona.ToString()));
    ...
    {
        Response.Redirect("~/Reportes/frmReporteAntiguedad.aspx");
    }
}