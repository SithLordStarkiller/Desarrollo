...
public partial class Reportes_frmRvReporteDesplegado : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptServicioIntegrantesDesplegados";
    ...
    {
        Response.Redirect("~/Reportes/frmReporteDesplegado.aspx");
    }
}