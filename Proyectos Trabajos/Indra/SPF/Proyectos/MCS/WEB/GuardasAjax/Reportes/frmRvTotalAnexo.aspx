<%@ Page Title="" Language="C#" MasterPageFile="~/Generales/MasterPage.master" AutoEventWireup="true" CodeFile="frmRvTotalAnexo.aspx.cs" Inherits="Reportes_frmRvTotalAnexo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tamanio">
        <tr>
            <td class="titulo">
                Reporte de Totales por Anexo</td>
        </tr>
    </table>
    <br />
