...
public partial class Reportes_frmRvEstadisticoZona : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptEstadisticoZona";
    ...
    {
        Response.Redirect("~/Reportes/frmEstadisticoZona.aspx");
    }
}