...
public partial class Reportes_frmRvReporteRotacion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            clsEntReporteIncidente objReporte = (clsEntReporteIncidente)Session["objReporteRotacion" + Session.SessionID];
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptReporteRotacion";
            ...
            parametrosReportes.Add(new ReportParameter("idZona", objReporte.ZonaEmpleadoInvolucrado.IdZona == 0 ? "0" : objReporte.ZonaEmpleadoInvolucrado.IdZona.ToString()));
            parametrosReportes.Add(new ReportParameter("idServicio", objReporte.Servicio.idServicio == 0 ? "0" : objReporte.Servicio.idServicio.ToString()));
            parametrosReportes.Add(new ReportParameter("idInstalacion", objReporte.Instalacion.IdInstalacion == 0 ? "0" : objReporte.Instalacion.IdInstalacion.ToString()));
    ...
    {
        Response.Redirect("~/Reportes/frmReporteRotacion.aspx");
    }
}