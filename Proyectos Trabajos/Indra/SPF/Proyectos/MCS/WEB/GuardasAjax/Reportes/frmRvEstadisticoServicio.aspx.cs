...
public partial class Reportes_frmRvEstadisticoServicio : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptEstadisticoCuentaCorportaiva";
            ...
            parametrosReportes.Add(new ReportParameter("fecha", objReporte.FechaReporte.ToShortDateString()));
    ...
    {
        Response.Redirect("~/Reportes/frmEstadisticoServicio.aspx");
    }
}