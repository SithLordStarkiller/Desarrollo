<%@ Page Title="" Language="C#" MasterPageFile="~/Generales/MasterPage.master" AutoEventWireup="true" CodeFile="frmRvNOIndicadores.aspx.cs" Inherits="Reportes_frmRvNOIndicadores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tamanio">
        <tr>
            <td class="titulo">
               Integrantes que no Aparecen en Indicadores</td>
        </tr>
    </table>
    <br />
