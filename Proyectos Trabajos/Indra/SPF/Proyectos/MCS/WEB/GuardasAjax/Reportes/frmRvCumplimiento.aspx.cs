...
public partial class Reportes_frmRvCumplimiento : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        clsEntReporteListado objReporte = (clsEntReporteListado)Session["objPersonalAsignado" + Session.SessionID];
        ...
        rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptCumplimiento";
        ...
        parametrosReportes.Add(new ReportParameter("datFecha", objReporte.FechaReporte.ToShortDateString()));
    ...
    {
        Response.Redirect("~/Reportes/frmCumplimiento.aspx");
    }
}