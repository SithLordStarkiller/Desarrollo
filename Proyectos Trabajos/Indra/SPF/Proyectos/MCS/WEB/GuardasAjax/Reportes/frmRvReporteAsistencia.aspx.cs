...
public partial class Reportes_frmRvReporteAsistencia : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptAsistencia";
    ...
    {
        Response.Redirect("~/Reportes/frmReporteAsistencia.aspx");
    }
}