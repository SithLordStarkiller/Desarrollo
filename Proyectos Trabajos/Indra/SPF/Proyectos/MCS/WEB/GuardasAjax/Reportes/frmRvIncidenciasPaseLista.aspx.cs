...
public partial class Reportes_frmRvIncidenciasPaseLista : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptIncidenciasPaseLista";
    ...
    {
        Response.Redirect("~/Reportes/frmIncidenciasPaseLista.aspx");
    }
}