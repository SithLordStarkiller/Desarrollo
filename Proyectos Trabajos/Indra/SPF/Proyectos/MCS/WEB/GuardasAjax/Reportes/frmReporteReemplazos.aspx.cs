...
public partial class Reportes_frmReporteReemplazos : System.Web.UI.Page
{
    ...
    protected void btnGenerar_Click(object sender, EventArgs e)
    {
        ...
        Session["objReemplazos" + Session.SessionID] = objReporteListado;
        Response.Redirect("~/Reportes/frmRvReemplazos.aspx");
    }
}