<%@ Page Title="" Language="C#" MasterPageFile="~/Generales/MasterPage.master" AutoEventWireup="true" CodeFile="frmRvPersonalAsignadoHistorico.aspx.cs" Inherits="Reportes_frmRvPersonalAsignadoHistorico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tamanio">
        <tr>
            <td class="titulo">
                Reporte de Programas Sustantivos</td>
        </tr>
    </table>
    <br />
