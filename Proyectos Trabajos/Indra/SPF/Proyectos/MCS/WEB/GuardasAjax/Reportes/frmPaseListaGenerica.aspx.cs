...
public partial class Reportes_frmPaseListaGenerica : System.Web.UI.Page
{
    ...
    protected void btnGenerar_Click(object sender, EventArgs e)
    {
        ...
        Session["objListaGenerica" + Session.SessionID] = objReporteListado;
        Response.Redirect("~/Reportes/frmRvPaseListaGenerica.aspx");
    }
}