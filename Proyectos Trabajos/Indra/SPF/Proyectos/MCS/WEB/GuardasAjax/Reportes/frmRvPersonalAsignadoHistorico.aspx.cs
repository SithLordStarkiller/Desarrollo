...
public partial class Reportes_frmRvPersonalAsignadoHistorico : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string strMes  = Session["intMes" + Session.SessionID].ToString();
        string strAnio = Session["intAnio" + Session.SessionID].ToString();
        ...
        rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptPersonalAsignadoHistorico";
        ...
        parametrosReportes.Add(new ReportParameter("intMes", strMes  ));
        parametrosReportes.Add(new ReportParameter("intAnnio", strAnio));
    ...
    {
        Response.Redirect("~/Reportes/frmPersonalAsignadoHistorico.aspx");
    }
}