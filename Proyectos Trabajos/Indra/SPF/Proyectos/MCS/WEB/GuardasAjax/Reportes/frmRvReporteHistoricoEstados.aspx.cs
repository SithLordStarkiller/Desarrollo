...
public partial class Reportes_frmRvReporteHistoricoEstados : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReporte.ServerReport.ReportPath = "/ReportesMCS/rptHIstoricoEstados";
            ...
            parametrosReportes.Add(new ReportParameter("intMes",Session["objMes" + Session.SessionID].ToString()));
            parametrosReportes.Add(new ReportParameter("intAnio",Session["objAnio" + Session.SessionID].ToString()));
    ...
    {
        Response.Redirect("~/Reportes/frmReporteHistoricoEstados.aspx");
    }
}