<%@ Page Title="" Language="C#" MasterPageFile="~/Generales/MasterPage.master" AutoEventWireup="true" CodeFile="frmPaseListaGenerica.aspx.cs" Inherits="Reportes_frmPaseListaGenerica" %>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="izq">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvServicio" runat="server" ErrorMessage="Se requiere el servicio."
                                                                Font-Bold="True" ControlToValidate="ddlServicio" SetFocusOnError="True" ValidationGroup="SICOGUA">*</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="der">
                                                        ...
                                                        <td class="izq">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvInstalacion" runat="server" ErrorMessage="Se requiere la instalación."
                                                                Font-Bold="True" ControlToValidate="ddlInstalacion" SetFocusOnError="True" ValidationGroup="SICOGUA">*</asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ContentTemplate>
