...
{
    public class clsDatHorario
    {
       
        public static DataTable consultarHorario(Int16 idHorario, Int16 idTipoHorario, clsEntSesion objSesion)
        {
            ...
            try
            {
                ...
                dbComando.CommandText = "catalogo.spConsultarHorario";
