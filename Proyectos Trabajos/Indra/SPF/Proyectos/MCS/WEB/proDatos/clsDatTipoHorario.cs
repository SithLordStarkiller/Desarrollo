...
{
    public class clsDatTipoHorario
    {
        public static DataTable consultarTipoHorario(Int16 idTipoHorario, clsEntSesion objSesion)
        {
            ...
            try
            {
                ...
                dbComando.CommandText = "catalogo.spConsultarTipoHorario";
