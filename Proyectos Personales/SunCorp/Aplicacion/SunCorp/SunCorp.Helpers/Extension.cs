...
namespace SunCorp.Helpers
{
    ...
    public static class Extensions
    {
        ...
        public static List<T> Convetidor<T>(this ObjectResult result) where T : new()
        {
            try
            {
                ...
                var dtlFieldNames = result.GetNextResult<ObjectResult>(); //dataTable.Columns.Cast<DataColumn>().
                //Select(item => new
                //{
